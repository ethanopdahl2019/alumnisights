  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger 
            className="bg-transparent hover:bg-transparent focus:bg-transparent data-[state=open]:bg-transparent text-navy font-medium hover:text-primary px-0"
          ...
          <NavigationMenuContent className="min-w-[240px] bg-white rounded-lg shadow-soft border border-gray-100">
