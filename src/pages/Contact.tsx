            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                <div>
                  ...
                  <a href="mailto:info@alumnisights.com" className="text-blue-600 hover:underline">
                    info@alumnisights.com
                  </a>
                </div>
                <div>
                  <p className="font-medium">Support:</p>
                  <a href="mailto:support@alumnisights.com" className="text-blue-600 hover:underline">
                    support@alumnisights.com
                  </a>
                </div>
                <div>
                  <p className="font-medium">Partnerships:</p>
                  <a href="mailto:partnerships@alumnisights.com" className="text-blue-600 hover:underline">
                    partnerships@alumnisights.com
                  </a>
                </div>
                <div>
